...
import IlaAlasepo1 from "../../assets/images/IlaAlasepo1.jpg"
...
const IlaAlasepo = () => {
  ...
  const ingredients = [
    ...
    { name: '1 tablespoon ground crayfish. ', amount: '1 tsp', image: GroundedCrayfish },
    { name: '1 teaspoon locust beans (iru)', amount: '1 tsp', image: locustBeans },
    { name: '1 teaspoon seasoning powder or cube.', amount: '1 tsp', image: SeasoningPowder },
    { name: '½ teaspoon salt. ', amount: '½ tsp', image: salt },
    { name: '1½ cup water', amount: '1½ cup', image: CupOfWater },
   
  ];

  const instructions = [
    'Heat palm oil and fry the chopped onions, blended peppers, and tomatoes.',
    'Add water or stock, followed by assorted meats and fish.',
    'Let it simmer, then stir in the grated okro and cook for a few minutes while stirring continuously.',
    'Add ground crayfish, iru, seasoning, and salt, then cook until it thickens. ',
    'Serve with amala, eba, or fufu.',
  ];
      ...
      <section className="max-w-7xl mx-auto p-4 pt-24">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Ila Alasepo</h1>
