...
import YamChopped from "../../assets/images/YamChopped.jpg";
...
import SeasoningPowder from "../../assets/images/SeasoningPowder.jpg"
import Onion from "../../assets/images/Onion.jpg" 
import SmokedProtein from "../../assets/images/SmokedProtein.jpg"
...
const Asaro = () => {
  ...
  const ingredients = [
    { name: '½ tuber white yam (peeled and chopped) ', amount: '½ tuber', image: YamChopped },
    { name: '2 tablespoons palm oil.', amount: '2 tsp', image: PalmOil },
    { name: '1 teaspoon ground crayfish.', amount: '1 tsp', image: crayfish },
    { name: '2 scotch bonnet peppers (blended).', amount: '2 fingers ', image: pepper },
    { name: '1 teaspoon locust beans (iru)', amount: '1 tsp ', image: locustBean },
    { name: '2 medium tomatoes (blended).', amount: '2 medium ', image: TomatoPaste },
    { name: '½ teaspoon salt (to taste). ', amount: '½ tsp ', image: salt },
    { name: 'Cups of water.', amount: '2 cups', image: CupOfWater },
    { name: '1 teaspoon seasoning powder', amount: '1 tsp', image: SeasoningPowder },
    { name: '1 medium onion (chopped)', amount: '1 medium ', image: Onion },   
    { name: '1 cup smoked protein (chopped)', amount: '1 cup', image: SmokedProtein },
  ];

  const instructions = [
    'In a pot, heat palm oil and sauté chopped onions.',
    ' Add blended tomatoes, scotch bonnet peppers, and crayfish, then fry until the oil floats on top. ',
    'Pour in water or stock and bring to a boil. Add the yam chunks and let them cook until soft.',
    'Stir gently to mash some of the yams while keeping some chunks intact.',
    'Add smoked fish, iru, seasoning, and salt, then stir to combine.',
    'If using vegetables, add them towards the end and allow the porridge to simmer for a few minutes.',
    'Serve hot as a standalone meal or with fried plantain and protein',
  ];
      ...
      <section className="max-w-7xl mx-auto p-4 pt-24">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Asaro</h1>
