...
const Ikokore = () => {
  ...
  const ingredients = [
    { name: '½ tuber white yam (peeled and chopped) ', amount: '½ tuber', image: waterYam },
    { name: '2 tablespoons palm oil.', amount: '2 tsp', image: PalmOil },
    { name: '1 teaspoon ground crayfish.', amount: '1 tsp', image: crayfish },
    { name: '1 cup assorted meats(shaki, pomo, beef)', amount: '1 cup ', image: meats },
    { name: '1 teaspoon locust beans (iru)', amount: '1 tsp ', image: locustBean },
    { name: '2 medium scotch bonnet peppers.', amount: '2 medium ', image: pepper },
    ...
    { name: '2 cups smoked protein (chopped)', amount: '2 cups', image: SmokedProtein },
  ];

  const instructions = [
    'Peel and wash the water yam.Grate it using a small-hole grater to form a smooth, sticky paste.',
    'Do not add water.In a pot, heat the palm oil over medium heat.',
    'Add locust beans (iru), blended pepper, and crayfish. Fry for 2–3 minutes.',
    'Pour in the water or stock and bring to a gentle boil.Scoop small portions of the grated yam into the pot without stirring.',
    'Cover and let it cook for 5 minutes so the yam lumps firm up.',
    'Add the assorted meats, smoked fish, seasoning, and salt.',
    'Gently stir to mix without breaking the yam lumps completely.',
    'Let it cook for another 5–7 minutes, stirring occasionally.',
    'Serve hot, either alone or with eko (agidi), garri.',
  ];
      ...
      <section className="max-w-7xl mx-auto p-4 pt-24">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Ikokore</h1>
