...
import Gbegiri2 from "../../assets/images/Gbegiri2.jpg"
import Gbegiri3 from "../../assets/images/Gbegiri3.jpg"
...
const Gbegriri = () => {
  ...
  const ingredients = [
    { name: '1 cup black-eyed beans or brown beans ', amount: '225g', image: Beans },
    { name: '2 tablespoons palm oil.', amount: '2 tsp', image: PalmOil },
    { name: '1 small onion (chopped) ', amount: '225g', image: Onion },
  ...
  const instructions = [
    'Soak the beans in water for about 10 minutes to soften the skin.Rub the beans between your hands or use a blender with little water to remove the skin.',
    'Rinse the peeled beans and boil in water until very soft (about 30–40 minutes).Drain excess water and blend the cooked beans into a smooth paste.',
    'You can also mash them with a wooden spoon or whisk if you prefer a rough texture.',
    'Pour the blended beans into a pot and add more water to achieve your preferred consistency.',
    'Stir continuously to prevent lumps.Add palm oil, chopped onions, crayfish, blended pepper, and locust beans (iru).',
    'Season with salt and seasoning powder.',
    'Cook for another 5–10 minutes, stirring occasionally.',
    'Remove from heat and serve hot with amala, ewedu.'
  ];
      ...
      <section className="max-w-7xl mx-auto p-4 pt-24">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Gbegriri</h1>
